-- =============================================================================
-- 079 — criar_venda_completa: estrangeiro + passaporte no INSERT de cliente PF
-- =============================================================================
-- Recria a RPC `criar_venda_completa` espelhando a versão de 061
-- (`061_rpcs_primeira_parcela_extra.sql`) e acrescentando `estrangeiro` e
-- `passaporte` ao INSERT do cliente novo PF. Os ALTER TABLE relacionados
-- já existem (067 + 078). Nenhuma outra alteração de comportamento.
-- =============================================================================
